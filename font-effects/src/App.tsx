                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {canvasSizes.map(size => (
                        <button
                          ...
                          className={`py-2 px-3 rounded-lg text-center transition-all duration-200 border-2 text-sm truncate ${canvasSizeId === size.id ? 'bg-cyan-600 border-cyan-400' : 'bg-gray-700 border-gray-600 hover:bg-gray-600'
                            }`}
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {textBlocks.map(textBlock => (
                      <button
                        ...
                        className={`py-2 px-3 rounded-lg transition-colors text-sm ${selectedTextBlockId === textBlock.id ? 'bg-cyan-600 text-white' : 'bg-gray-700 hover:bg-gray-600'
                          }`}
                      >
